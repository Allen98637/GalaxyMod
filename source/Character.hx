	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'kastimagina':
				...
				animation.addByPrefix('singLEFT-alt', 'jumpleft', 24, false);
				animation.addByPrefix('singRIGHT-alt', 'jumpright', 24, false);

				addOffset('idle');
				addOffset("singUP", 41, 9);
				addOffset("singRIGHT", -53, 6);
				addOffset("singLEFT", 75, 14);
				addOffset("singDOWN", -9, -9);
				addOffset("singUP-alt", 57, 265);
				addOffset("singRIGHT-alt", 1, 211);
				addOffset("singLEFT-alt", 36, 195);
